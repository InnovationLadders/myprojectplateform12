...
// Mock favorite consultants data
const mockFavorites = [
  {
    id: '1',
    name: 'د. محمد العتيبي',
    title: 'مستشار تقني',
    specialties: ['الذكاء الاصطناعي', 'تعلم الآلة', 'الروبوتات'],
    rating: 4.9,
    reviews: 124,
    experience: '10+ سنوات',
  ...
  },
  {
    id: '2',
    name: 'أ. سارة الشمري',
    title: 'مستشارة أكاديمية',
    specialties: ['التعليم', 'المناهج الدراسية', 'تطوير المهارات'],
    rating: 4.8,
    reviews: 98,
    experience: '8+ سنوات',
  ...
  },
  {
    ...
    name: 'م. خالد الدوسري',
    title: 'مستشار هندسي',
    specialties: ['الهندسة الميكانيكية', 'الطاقة المتجددة', 'التصميم الهندسي'],
    rating: 4.7,
    reviews: 87,
    experience: '12+ سنوات',
  ...
  },
  {
    ...
    specialties: ['التعليم الإلكتروني', 'تطوير المناهج', 'التقييم التربوي'],
    rating: 4.9,
    reviews: 112,
    experience: '15+ سنوات',
  ...
  },
  {
    ...
    name: 'أ. فهد العنزي',
    title: 'مستشار مالي',
    specialties: ['التخطيط المالي', 'الاستثمار', 'إدارة الميزانية'],
    rating: 4.6,
    reviews: 76,
    experience: '7+ سنوات',
