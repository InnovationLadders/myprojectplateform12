        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="opacity-90">{t('projects.subtitle')}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            <div className="text-2xl font-bold">
              {projects.length > 0 ? (Math.round(projects.reduce((acc, p) => acc + (p.progress || 0), 0) / projects.length * 10) / 10).toFixed(1) : 0}
            </div>
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                ...
                <Link
                  ...
                  className="text-xl font-bold text-gray-800 hover:text-blue-600 transition-colors line-clamp-2"
                >
                  {project.title}
                </Link>
              </div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  className={`h-2 rounded-full transition-all duration-300 ${
                    project.progress >= 9 ? 'bg-green-500' : 
                    project.progress >= 5 ? 'bg-blue-500' : 'bg-yellow-500'
                  }`}
