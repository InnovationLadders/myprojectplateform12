      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">{t('createProject.title')}</h1>
            <p className="text-gray-600">{t('createProject.subtitle')}</p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600">{t('createProject.initialProgress')}:</span>
