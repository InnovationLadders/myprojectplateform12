...
export const IntellectualProperty: React.FC = () => {
  ...
  const { intellectualProperties, loading, error } = useIntellectualProperty();
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="bg-white text-purple-600 px-6 py-3 rounded-xl font-medium hover:bg-opacity-90 transition-all duration-200 flex items-center gap-2">
      ...
      {filteredProperties.length === 0 && (
        ...
        >
          ...
          <div className="flex justify-center gap-4">
            <button className="px-6 py-2 bg-purple-500 text-white rounded-xl hover:bg-purple-600 transition-colors flex items-center gap-2">
